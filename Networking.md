...
<b> 💡 Interview Tip
Saying "REST for external, gRPC for internal" is a clean, defensible default. If asked to justify it: "REST is universally understood and easy for external consumers. gRPC gives us type safety and binary encoding for high-throughput internal calls." Simple. </b>
...
- Route /api/* requests to your API servers and /images/* to your static file servers
